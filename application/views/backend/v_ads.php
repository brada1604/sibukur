...
<html>
    ...
    <body class="page-header-fixed  compact-menu  pace-done page-sidebar-fixed">
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    ...
                    <ul class="menu accordion-menu">
                        ...
                        <li class="active"><a href="<?php echo site_url('backend/ads');?>" class="waves-effect waves-button"><span class="menu-icon icon-drawer"></span><p>Ads</p></a></li>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: middle;">
                                                    <img width="50" src="<?php echo base_url().'assets/depan/img/ads/'.$row->ads_image;?>">
                                                </td>
                                                <td style="vertical-align: middle;"><?php echo $row->ads_title;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->ads_category;?></td>
                                                <td style="vertical-align: middle;"><?php echo $row->ads_description;?></td>
                                                <td style="vertical-align: middle;"><a href="<?php echo $row->ads_map;?>" target="_blank"><?php echo $row->ads_map;?></a></td>
                                                <td style="vertical-align: middle;"><a href="<?php echo $row->ads_whatsapp;?>" target="_blank"><?php echo $row->ads_whatsapp;?></a></td>
                                                <td style="vertical-align: middle;"><?php echo $row->ads_contact;?></td>
                                                <td style="vertical-align: middle;">
                                                    <?php
                                                        $harga = str_replace(',', '.', $row->ads_price); // ubah koma jadi titik
                                                        $harga = floatval($harga); // ubah ke float

                                                        // cek apakah ada desimal atau tidak
                                                        if (fmod($harga, 1) > 0) {
                                                            echo 'Rp ' . number_format($harga, 2, ',', '.'); // tampilkan 2 digit desimal
                                                        } else {
                                                            echo 'Rp ' . number_format($harga, 0, ',', '.'); // tampilkan tanpa desimal
                                                        }
                                                    ?>
                                                </td>
                                                <td style="vertical-align: middle;">
                                                    <div class="btn-group">
                                                        ...
                                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <li><a href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->ads_id;?>"><span class="icon-pencil"></span> Edit</a></li>
                                                            <li><a href="javascript:void(0);" class="delete" data-userid="<?php echo $row->ads_id;?>"><span class="icon-trash"></span> Delete</a></li>
                                                        </ul>
                                                    </div>
                                                </td>
                                            </tr>
        ...
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'backend/ads/insert'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Add Ads</h4>
                    </div>
                    <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="map" class="form-control" placeholder="Map" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" name="whatsapp" class="form-control" placeholder="Whatsapp" required>
                                    </div>
                                    <div class="form-group">
                                        <textarea name="contact" class="form-control" rows="3" placeholder="Contact" required></textarea>
                                    </div>
                                    <div class="form-group">
        ...
        ?>
        <!-- Modal -->
        <form id="add-row-form" action="<?php echo base_url().'backend/ads/update'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalEdit<?php echo $row->ads_id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Edit Ads</h4>
                    </div>
                    <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                                <input type="file" name="filefoto" class="dropify" data-height="180" data-default-file="<?php echo base_url().'assets/depan/img/ads/'.$row->ads_image;?>">
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            <input type="text" name="title" value="<?php echo $row->ads_title;?>" class="form-control" placeholder="Title" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="description" class="form-control" rows="6" placeholder="Description" required><?php echo $row->ads_description;?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <select class="form-control" name="category" required>
                                                <option value="Produk" <?= ($row->ads_category === "Produk") ? "selected" : "" ?>>Produk</option>
                                                <option value="Pariwisata" <?= ($row->ads_category === "Pariwisata") ? "selected" : "" ?>>Pariwisata</option>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="description" class="form-control" rows="3" placeholder="Description" required><?php echo $row->ads_description;?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="map" value="<?php echo $row->ads_map;?>" class="form-control" placeholder="Map" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="text" name="whatsapp" value="<?php echo $row->ads_whatsapp;?>" class="form-control" placeholder="Whatsapp" required>
                                        </div>
                                        <div class="form-group">
                                            <textarea name="contact" class="form-control" rows="3" placeholder="Contact" required><?php echo $row->ads_contact;?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <input type="number" name="price" value="<?php echo $row->ads_price;?>" class="form-control" placeholder="Price" required>
                                        </div> 
                    ...
                    <div class="modal-footer">
                        <input type="hidden" name="ads_id" value="<?php echo $row->ads_id;?>" required>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
       ...
       <!-- Modal hapus-->
        <form id="add-row-form" action="<?php echo base_url().'backend/ads/delete'?>" method="post" enctype="multipart/form-data">
        <div class="modal fade" id="ModalDelete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="myModalLabel">Delete Ads</h4>
                    </div>
                    <div class="modal-body">
                            <strong>Anda yakin mau menghapus ads ini?</strong>
                            <div class="form-group">
