    ...
    <div class="row align-items-start">
      ...
      <div class="col-lg-6">
        ...
        <h3 class="text-success font-weight-bold">
            <?php
                $harga1 = str_replace(',', '.', $price); // ubah koma jadi titik
                $harga1 = floatval($harga1); // ubah ke float

                // cek apakah ada desimal atau tidak
                if (fmod($harga1, 1) > 0) {
                    echo 'Rp ' . number_format($harga1, 2, ',', '.'); // tampilkan 2 digit desimal
                } else {
                    echo 'Rp ' . number_format($harga1, 0, ',', '.'); // tampilkan tanpa desimal
                }
            ?>
        </h3>
        ...
        <div class="mt-4">
          <ul class="list-group list-group-flush border rounded shadow-sm">
            ...
            <?php
                $harga2 = str_replace(',', '.', $price); // ubah koma jadi titik
                $harga2 = floatval($harga2); // ubah ke float

                // cek apakah ada desimal atau tidak
                if (fmod($harga2, 1) > 0) {
                    echo 'Rp ' . number_format($harga2, 2, ',', '.'); // tampilkan 2 digit desimal
                } else {
                    echo 'Rp ' . number_format($harga2, 0, ',', '.'); // tampilkan tanpa desimal
                }
            ?>
            </li>
            <li class="list-group-item">
         ...
         <div class="mt-3">
            <div class="row g-2">
                ...
                <div class="col-6">
                    <a href="<?php echo $whatsapp;?>?text=Halo,%20saya%20tertarik%20dengan%20<?php echo $title;?>" target="_blank" class="btn btn-success w-100 btn-sm">
